...
define('DATABASE_PASS', 'vipsubestosusv');		// MySQL password
define('DATABASE_NAME', 'ripple');		// Database name
define('DATABASE_WHAT', 'host');		// "host" or unix socket path

// Server urls, no slash
$URL = [
	'avatar' => 'http://a.vipsu.ml',
	'server' => 'http://vipsu.ml',
	'bancho' => 'http://c.vipsu.ml',
	'scores' => 'http://5.83.160.198:5002/'
];
...
$ScoresConfig = [
	...
	"api_key" => "b02067a68ada8718c09326889af593b400bccc3d",
