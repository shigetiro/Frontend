...
class Verify {
	const PageID = 38;
	const URL = 'verify';
	const Title = 'Vipsu - Verify your account';
		...
		try {
			...
			echo '<div id="narrow-content">
				...
				<p>
					...
					You don\'t know how to connect to Vipsu? Follow <a target="_blank" href="index.php?p=16&id=1">this guide</a>!<br>
				</p>
				<hr>
				<i class="fa fa-circle-o-notch fa-spin fa-3x fa-fw"></i>
				<h3>Wait to login in-game...</h3>
			</div>';
		} catch (Exception $e) {
			redirect("index.php");
		}
