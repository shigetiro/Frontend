...
class Login {
	...
	public function P() {
		...
		<div class="input-group"><span class="input-group-addon" id="basic-addon1"><span class="glyphicon glyphicon-lock" max-width="25%"></span></span><input type="password" name="p" required class="form-control-black" placeholder="Password" aria-describedby="basic-addon1"></div>
