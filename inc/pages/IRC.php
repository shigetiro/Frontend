	...
	public function P() {
		...
		<div id="content">
			<div align="center">
				...
				Here you can generate a new IRC token. You can use it to connect to Verge\'s chat using IRC.<br>
				Remember that your IRC token is like a password, anyone who knows it, has access to your account.<br>
				<a href="index.php?p=16&id=11">Click here to know how to connect to Verge through IRC</a><br><br>
