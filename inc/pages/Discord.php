...
class Discord {
	const PageID = 40;
	const URL = 'Discord';
	const Title = 'Verge - Discord Donor';
	const LoggedIn = true;
	...
	public function P() {
		...
		if (!isset($_GET["code"]) || empty($_GET["code"])) {
			...
			echo '<b>Donors get special privileges on our Discord server too!</b><br>
				...
				echo '<p class="half">Your discord account has been <b>linked</b> to this Verge account. <b>Welcome to the donors club and thank you for supporting us!</b>
			...
			<br><br>
			<h4>Thank you for supporting us and have fun on Verge!</h4></p>';
			}
		} else {
			$this->D();
		}
