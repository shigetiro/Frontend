	...
	public function P() {
		...
		try {
			...
			if (hasPrivilege(Privileges::UserPublic, $_GET["u"])) {
				echo '<h1><i class="fa fa-hand-peace-o"></i> Welcome to Vipsu!</h1>
				<p>
					<b>Congratulations, your account is now active!</b> Have fun playing on Vipsu!<br>
				...
				<h4><i class="fa fa-gavel"></i>	<a target="_blank" href="index.php?p=16&id=2">Rules</a></h4>
				<h4><i class="fa fa-question-circle"></i>	<a target="_blank" href="https://vk.com/im?media=&sel=-139469474">Help</a></h4>
	       ...
	       ';   /*<h4><i class="fa fa-server"></i>	<a target="_blank" href="http://status.ripple.moe">Server Status</a></h4>
				...
				<h3>Multiaccounts are not allowed on Vipsu.</h3>
				<hr>
				<p>
