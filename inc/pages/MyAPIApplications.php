...
class MyAPIApplications {
	...
	const Title = 'Verge - My Applications';
	const LoggedIn = true;
	...
	public function P() {
		...
		<div id="narrow-content" style="width:500px">
			...
			<p>The Verge public API allows developers to easily make applications and utilities that integrate with Verge. If you don't know what an API is, you probably don't need to do anything on this page.</p>
			<p><a href="https://en.wikipedia.org/wiki/Application_programming_interface">API (Wikipedia)</a> | <a href="https://git.zxq.co/ripple/api-docs/wiki">Verge API documentation</a></p>
			<?php
			if (!$myApps) {
